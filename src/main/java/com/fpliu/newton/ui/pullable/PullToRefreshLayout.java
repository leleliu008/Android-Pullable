 ...
 * 还有一个上拉头
 */
public class PullToRefreshLayout<H extends View, V extends View, L extends View> extends RelativeLayout {
    ...
    public void changeState(int to) {
        ...
        refreshingAnimation = getRefreshingAnimation();
    ...
    public void setRotateAnimation(RotateAnimation refreshingAnimation) {
        this.rotateAnimation = refreshingAnimation;
    }
     ...
     * @return
     */
    public RotateAnimation getRefreshingAnimation() {
        if (refreshingAnimation == null) {
            ...
            refreshingAnimation.setRepeatCount(Animation.INFINITE);
            refreshingAnimation.setInterpolator(new LinearInterpolator());
        }
        return refreshingAnimation;
    }

    public void setRefreshingAnimation(RotateAnimation refreshingAnimation) {
        this.refreshingAnimation = refreshingAnimation;
    }
